...
//   const [typeConversion, setTypeConversion] = useState('avif2png');
  ...
  return (
    ...
    <Helmet>
      <title>{"JPG to PNG – Convert JPG to PNG Online Free"}</title>
      <meta name="keywords" content="jpg to png, jpeg to png, jpg convert to png, jpg to png converter"/>
      <meta name="description" content={`Convert JPG to PNG - Efficiently convert your JPEG images to PNG format using this free online tool. Bulk conversion supported with no sign-up condition.`} />
    </Helmet> 
...
{isSignupPopupVisible && (
   ...
   {!loading&&(
      ...
      <MainComponnent defaultConversion={'jpg2png'} convertHeading={''}/> 
